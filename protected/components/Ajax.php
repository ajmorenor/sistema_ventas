...
$this->msg=t("We have sent bank information instruction to your email")." :$merchant_email";
	...
	public function AdminCulquiSettings()
	{
		Yii::app()->functions->updateOptionAdmin("admin_cul_enabled",
	    isset($this->data['admin_cul_enabled'])?$this->data['admin_cul_enabled']:'');
	    
	    Yii::app()->functions->updateOptionAdmin("admin_cul_merchant_id",
	    isset($this->data['admin_cul_merchant_id'])?$this->data['admin_cul_merchant_id']:'');
