...
{	
	...
	public function merchantMenu()
	{
		...
		$payment_list=array('visible'=>FunctionsV3::hasMerchantAccessToMenu($user_access,"payment-gateway"),'tag'=>'payment-gateway','label'=>'<i class="fa fa-usd"></i>'.Yii::t("default",'Payment Gateway'),
                   ...
                   //add culqui
                   array('visible'=>FunctionsV3::hasMerchantAccessToMenu($user_access,"cul"),'tag'=>'cul', 'label'=>'<i class="fa fa-paypal"></i>'.Yii::t("default","culqui"), 
                   'url'=>array('merchant/culqui')),                                                                                              
		...
		return array(  
		    ...
		    'items'=>array(
                ...
                'label'=>'<i class="fa fa-usd"></i>'.Yii::t("default",'Payment Gateway'),
                   ...
                   //add Culqui
                   array('visible'=>$this->AA('culqui'),'tag'=>'culqui',
                   'label'=>'<i class="fa fa-paypal"></i>'.Yii::t("default","Culqui"), 
                   'url'=>array('admin/culqui')), 
